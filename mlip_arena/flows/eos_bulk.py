...
def calculate_metrics(
    res_eos: dict, b0: float, wbm_struct: Atoms, model_name: str, structure_id: str
) -> dict:
...
def eos_bulk_task(atoms: Atoms, model_name: str, model: str | BaseCalculator):
        ...
        for row in db.select():
            ...
            try:
                ...
                data = calculate_metrics(
                    res_eos, b0, wbm_struct, model_name, structure_id
                )
            except Exception:
                data = {
                    "model": model_name,
