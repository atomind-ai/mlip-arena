"""
================================================================================
MLIP Arena - Benchmark Submission Template
================================================================================
...
3. Run directly: `python submit_model.py`
================================================================================
"""
...
# ==============================================================================
# 2. INTERNAL PIPELINE EXECUTOR (No need to modify)
# ==============================================================================
...
def benchmark_model(model: str | BaseCalculator):
    ...
    homonuclear_diatomics.with_options(name=f"diatomics-{model_name}")(
    ...
    wbm_eos_bulk.with_options(name=f"eos_bulk-{model_name}")(
        model=model, run_dir=out_dir_eos
    )

    # 3. E-V
    print(f"Starting E-V scan benchmark for {model_name}...")
    out_dir_ev = Path.cwd() / "ev"
    wbm_ev_scan.with_options(name=f"ev-{model_name}")(model=model, run_dir=out_dir_ev)
